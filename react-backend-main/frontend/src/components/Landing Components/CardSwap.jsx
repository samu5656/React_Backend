...
return (
    <div
      ...
      className={`
        absolute bottom-0 left-0 lg:left-auto lg:right-0 
        transform origin-left lg:origin-bottom-right 
        perspective-[1200px] overflow-visible
        
        /* Mobile adjustments */
        translate-x-[10%] translate-y-[10%] scale-[0.7]
        
        /* Tablet adjustments */
        md:scale-[0.85] md:translate-x-[5%]
        
        /* Desktop adjustments */
        lg:translate-x-[5%] lg:translate-y-[20%] lg:scale-100
      `}
      style={{ width, height }}
    >
      {rendered}
