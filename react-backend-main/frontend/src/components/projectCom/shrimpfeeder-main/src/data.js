...
export const team = [
  {
    photo: asset("team/dineshvaran.jpeg"),
    name: "Dineshvaran S",
  ...
  {
    photo: asset("team/theneeshwaran.jpeg"),
  ...
  {
    photo: asset("team/brathikan.jpeg"),
    name: "Brathikan V. M",
