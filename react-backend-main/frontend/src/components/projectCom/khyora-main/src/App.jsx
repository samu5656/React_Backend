          ...
          <div className="wrap hero__grid">
            ...
            <div className="hero__media">
              <div className="hero__portal" id="heroPortal" data-speed="0.8">
                <img className="hero__scene" src="/assets/hero-scene.jpg" alt="" aria-hidden="true" />
                <span className="ripple ripple--1" aria-hidden="true"></span>
                <span className="ripple ripple--2" aria-hidden="true"></span>
                <img className="hero__product" id="heroProduct" src="/assets/topsheet.png" alt="Khyora flushable bio-based sanitary pad" />
          ...
          <div className="wrap">
            <div className="solution__grid">
              ...
              <div className="solution__media">
                <img src="/assets/core.png" alt="Khyora bio-based absorbent core" data-speed="1.4" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="layers" data-screen-label="Layers Scene">
          <div className="layers__sticky">
            ...
            <div className="layers__stage" id="layersStage">
              <div className="layer layer--top" id="layTop"><img src="/assets/topsheet.png" alt="Top layer" /></div>
              <div className="layer layer--core" id="layCore"><img src="/assets/core.png" alt="Bio-based absorbent core" /></div>
              <div className="layer layer--back" id="layBack"><img src="/assets/topsheet.png" alt="Backsheet" /></div>
